...
object DrawableMapper {
    ...
    fun getSpellDrawableFromName(string: String): Int {
        when (string.lowercase(Locale.ROOT).replace(" ", "")) {
            ...
            "earthenbulwark" -> return R.drawable.earthen_bulwark
            ...
            "groundstomp" -> return R.drawable.groundstomp
            ...
            "shadowimbuement" -> return R.drawable.shadowimbuement
            "shadowstep" -> return R.drawable.shadow_step
            "stormstrike" -> return R.drawable.storm_strike
            "teleport" -> return R.drawable.teleport
            ...
            "wrathoftheberserker" -> return R.drawable.wrath_of_the_berserker
        }
